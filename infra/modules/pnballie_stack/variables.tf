...
variable "org_prefix" {
  description = "Organization prefix (pnb-dlb)"
  type        = string
  default     = "pnb-dlb"
}

variable "env_short" {
  description = "Short environment code, e.g. p"
  type        = string
  default     = "p"
}
...
variable "compose_content" {
  description = "Rendered docker-compose.prod.yml content for cloud-init bootstrap"
  type        = string
}

variable "caddyfile_content" {
  description = "Rendered Caddyfile content for cloud-init bootstrap"
  type        = string
}
